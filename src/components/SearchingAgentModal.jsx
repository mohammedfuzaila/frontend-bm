          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            {isFailed ? (
              ...
              <>
                ...
                <h2 style={{ fontWeight: 800, fontSize: '1.8rem', marginBottom: '1rem', color: '#EF4444' }}>Agents are Busy</h2>
                <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '2.5rem' }}>
                  Our professional agents are currently occupied with other tasks. Please try again after some time.
                </p>
                <button 
                  onClick={onCancel}
                  style={{ 
